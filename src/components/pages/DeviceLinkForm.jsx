             ...
             <FormControl fullWidth>
              <Grid  container spacing={2} justifyContent="center" alignItems="center">
                ...
                <Input
                  ...
                  label="Device Param Code"
                  name="DeviceParamCode"
                  type="number"
                  size="large"
                  id="outlined-basic"
                  variant="outlined"
                  value={values.DeviceParamCode}
                  onChange={handleChange}
                  onBlur={handleBlur}
                  helperText={
                    errors.DeviceParamCode && touched.DeviceParamCode ? (
                      <span style={{ color: "red" }}>
                        {errors.DeviceParamCode}
                      </span>
                    ) : null
                  }
                />
