    ...
    const exportExcelfile = async () => {
      ...
      sheet.getRow(1).font = { bold: true };
        ...
        sheet.columns = [
          ...
          { header: "fromDate", key: 'fromDate', width: columnWidths.fromDate, style: headerStyle },
        
          { header: "toDate", key: 'toDate', width: columnWidths.toDate, style: headerStyle },
          { header: "trainerName", key: 'trainerName', width: columnWidths.trainerName, style: headerStyle },
