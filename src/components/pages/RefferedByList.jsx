...
const RefferedByList = () => {
    ...
    return (
        <>
            ...
            >
                ...
                <Stack sx={{ display: 'flex', flexDirection: 'row' }} marginY={1} paddingX={1}>
                    <ButtonGroup variant="contained" aria-label="Basic button group">
                        ...
                        <Button variant="contained"  color="success" endIcon={<PictureAsPdfIcon/>}>PDF</Button>
                        <Button variant="contained"   color="success" endIcon={<DownloadIcon/>}>Excel</Button>
                    </ButtonGroup>
            ...
            <Popup resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Reffered By">
