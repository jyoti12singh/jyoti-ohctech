...
import EmployeeAppointmentForm from './EmployeeAppointmentForm';
import * as Yup from 'yup';

const EmployeeAppointmentValidationForm = Yup.object({
    appointmentdate: Yup.string().required("Please enter Date of Appointment"),
    appointmenttype: Yup.string().required("Please select appointment type"),
    doctorname: Yup.string().required("Please select doctor Name"),
...
const EmployeeAppointmentList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema:EmployeeAppointmentValidationForm,
   ...
   const CustomActionComponent = ({id}) => {
    ...
    const exportpdf = async () => {
        ...
        const doc = new jsPDF();
        const header = [['Id','Appointment Type', 'Appointment Date',"Doctor Name","Patient Name","Time","Status" ]];
        ...
        doc.save("EmployeeAppointmentList.pdf");
    };
    ...
    const exportExcelfile = async () => {
      ...
      sheet.getRow(1).font = { bold: true };
        ...
        sheet.columns = [
          ...
          { header: "Appointment Type", key: 'appointmenttype', width: columnWidths.appointmenttype, style: headerStyle },
          { header: "Appointment Date", key: 'appointmentdate', width: columnWidths.appointmentdate, style: headerStyle },
          ...
          { header: "Time", key: 'time', width: columnWidths.time, style: headerStyle },
        ...
        rowData.map(product =>{
            sheet.addRow({
                Id: product.Id,
                appointmenttype: product.appointmenttype,
                appointmentdate: product. appointmentdate,
        ...
        workbook.xlsx.writeBuffer().then(data => {
            ...
            anchor.href = url;
            anchor.download = 'EmployeeAppointmentList.xlsx';
            anchor.click();
    ...
    return (
        ...
        <ToastContainer />
            ...
            <Popup showupdate={showupdate} id= {id} handleUpdate={handleUpdate} setShowupdate={setShowupdate} resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Employee Appointment ">

                <  EmployeeAppointmentForm values={values} touched={touched} errors={errors} handleBlur={handleBlur} handleChange={handleChange} setFieldValue={setFieldValue} handleSubmit={handleSubmit} />
