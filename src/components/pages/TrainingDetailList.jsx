...
const TrainingDetailList = () => {
   ...
   const CustomActionComponent = ({id}) => {
    ...
    const headerMappings = {
        ...
        prokeyHealthParamSectiongramMode : "keyHealthParamSection",
    };      
    ...
    const exportExcelfile = async () => {
      ...
      sheet.getRow(1).font = { bold: true };
        ...
        sheet.columns = [
          ...
          { header: "programName", key: 'programName', width: columnWidths.programName, style: headerStyle },
         
          { header: "programdescription", key: 'programdescription', width: columnWidths.programdescription, style: headerStyle },
        
          { header: "programDuration", key: 'programDuration', width: columnWidths.programDuration, style: headerStyle },
          { header: "programMode", key: 'programMode', width: columnWidths.programMode, style: headerStyle },
          { header: "programType", key: 'programType', width: columnWidths.programType, style: headerStyle },
          { header: "keyHealthParamSection", key: 'keyHealthParamSection', width: columnWidths.keyHealthParamSection, style: headerStyle },
        ];
