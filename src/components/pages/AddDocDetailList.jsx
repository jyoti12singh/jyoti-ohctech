...
const AddDocDetailList = () => {
    ...
    const initialValues = {
      ...
      const {
        ...
        validationSchema: AddDocValidationForm,
    ...
    return (
        <>
            ...
            <Popup resetForm={resetForm} handleSubmit={handleSubmit}  openPopup={openPopup} setOpenPopup={setOpenPopup} title="Add Doctor Details">
