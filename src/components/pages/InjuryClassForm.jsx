              ...
              <Grid container spacing={2}  justifyContent="center" alignItems="center">
                <Grid item xs={12}  container spacing={1} justifyContent="center" alignItems="center">
                  <Input
                    ...
                    onBlur={handleBlur}
                    helperText={
                      errors.Injury_Name && touched. Injury_Name? (
                        <span style={{ color: "red" }}>{errors. Injury_Name}</span>
                      ) : null
                    }
                  />
                </Grid>
                <Grid item xs={12}  container spacing={1} justifyContent="center" alignItems="center">
                  <Input
                    ...
                    type="text"
                    size="large"
                    value={values.Injury_Description}
                    onChange={handleChange}
                    onBlur={handleBlur}
                    helperText={
                      errors.Injury_Description && touched.Injury_Description ? (
                ...
                <Grid item xs={12}  container spacing={1} justifyContent="center" alignItems="center">
                  <Input
                    ...
                    type="text"
                    size="large"
                    value={values. Injury_Code}
                    onChange={handleChange}
                    onBlur={handleBlur}
                    helperText={
                      errors. Injury_Code && touched. Injury_Code ? (
                        <span style={{ color: "red" }}>{errors. Injury_Code}</span>
                      ) : null
                    }
                  />
                </Grid>
...
export default InjuryClassForm;
